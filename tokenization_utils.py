...
class PreTrainedTokenizer(object):
    ...
    def __init__(self, max_len=None, **kwargs):
        ...
        print("初始化OpenAIGPTTokenizer时的kwargs",kwargs)#
    ...
    def _from_pretrained(cls, pretrained_model_name_or_path, *init_inputs, **kwargs):
        ...
        print("s3_models",s3_models)#["openai-gpt"]
        vocab_files = {}
        init_configuration = {}
        if pretrained_model_name_or_path in s3_models:
            ...
            print("cls.vocab_files_names",cls.vocab_files_names)#{'vocab_file': 'vocab.json', 'merges_file': 'merges.txt'}
            if os.path.isfile(pretrained_model_name_or_path) or is_remote_url(pretrained_model_name_or_path):
                ...
                print("additional_files_names",additional_files_names)#{'added_tokens_file': 'added_tokens.json', 'special_tokens_map_file': 'special_tokens_map.json', 'tokenizer_config_file': 'tokenizer_config.json'}
        ...
        print("vocab_files",vocab_files)#vocab_files {'vocab_file': 'gpt_personachat_cache/vocab.json', 'merges_file': 'gpt_personachat_cache/merges.txt', 'added_tokens_file': 'gpt_personachat_cache/added_tokens.json', 'special_tokens_map_file': None, 'tokenizer_config_file': None}
        ...
        tokenizer_config_file = resolved_vocab_files.pop("tokenizer_config_file", None)#None
        ...
        print("init_configuration",init_configuration)#init_configuration {}
        # Update with newly provided kwargs
        init_kwargs.update(kwargs)
        print("init_kwargs",init_kwargs)#init_kwargs {}
        # Set max length if needed
        print("cls.max_model_input_sizes",cls.max_model_input_sizes)#cls.max_model_input_sizes {'openai-gpt': 512}
        ...
        print("init_kwargs2",init_kwargs)#init_kwargs2 {}
        # Merge resolved_vocab_files arguments in init_kwargs.
        added_tokens_file = resolved_vocab_files.pop("added_tokens_file", None)
        print("added_tokens_file",added_tokens_file)#added_tokens_file gpt_personachat_cache/added_tokens.json
        special_tokens_map_file = resolved_vocab_files.pop("special_tokens_map_file", None)
        print("special_tokens_map_file",special_tokens_map_file)#special_tokens_map_file None
        print("resolved_vocab_files2",resolved_vocab_files)#resolved_vocab_files2 {'vocab_file': 'gpt_personachat_cache/vocab.json', 'merges_file': 'gpt_personachat_cache/merges.txt'}
        ...
        print("init_kwargs3",init_kwargs)#init_kwargs3 {'vocab_file': 'gpt_personachat_cache/vocab.json', 'merges_file': 'gpt_personachat_cache/merges.txt'}
        # Instantiate tokenizer.
        print("init_inputs",init_inputs)#init_inputs ()
        try:
            tokenizer = cls(*init_inputs, **init_kwargs)#是OpenAIGPTTokenizer
        except OSError:
            raise OSError(
    ...
    def add_tokens(self, new_tokens):
        ...
        for token in new_tokens:
            ...
            print("self.convert_tokens_to_ids(token)",self.convert_tokens_to_ids(token))
            print("self.convert_tokens_to_ids(self.unk_token)",self.convert_tokens_to_ids(self.unk_token))
